        ...
        if($this->config['debug']) {
            ...
            if(!$isreturn){
                ...
                if(!(defined("ISCLI")&&ISCLI)){
                    //cli模式下不退出进程
                    $msg = "<b>SqlSrv Query : </b> $sql <br /><b> SqlSrv Error : </b>".$errmsg." <br /> <b>SqlSrv Errno : </b>".$errno." <br /><b> Message : </b> $message <br />";
                    ...
                    $_errormsg.="SqlSrv Error:".$errmsg.PHP_EOL;
                    $_errormsg.="SqlSrv Errno:".$errno.PHP_EOL;
