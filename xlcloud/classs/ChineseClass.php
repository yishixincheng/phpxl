...
class ChineseClass extends XlClassBase {
    ...
    public static function tradition2simple($sContent){
        ...
        $iContent=mb_strlen($sContent,static::$charset);
        $simpleCN='';
        for($i=0;$i<$iContent;$i++){
            $str=mb_substr($sContent,$i,1,static::$charset);
            $match=mb_strpos(static::$td,$str,null,'UTF-8');
            $simpleCN.=($match!==false )?mb_substr(static::$sd,$match,1,static::$charset):$str;
    ...
    public static function simple2tradition($sContent){
        ...
        for($i=0;$i<$iContent;$i++){
            $str=mb_substr($sContent,$i,1,static::$charset);
            $match=mb_strpos(static::$sd,$str,null,static::$charset);
            $traditionalCN.=($match!==false )?mb_substr(static::$td,$match,1,static::$charset):$str;
