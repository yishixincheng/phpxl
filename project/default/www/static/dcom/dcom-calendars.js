...
(function(){
    ...
    function Calendar(pm,dcom){
        ...
        var _showmonth=pm['showmonth']||12;
        ...
        function getDayNodeHtm(d,y,m){
            ...
            var dts='';
            if(!isinvalid){
                dts='data-year="'+y+'" data-month="'+m+' data-event="select"';
            }
        ...
        function getMothHtm(y,m){
            ...
            var htm='<div class="dcom-calendar-wrap" ><div class="mt">'+y+'年</div><dl class="cw"><dt>';
